...
export default function DashboardOutlineIcon() {
  return (
    <svg
    ...
    >
      <defs>
        <clipPath id="clip-path-DashboardOutlineIcon">
          <rect
            id="Rectangle_2643"
            data-name="Rectangle 2643"
            width="16"
            height="16"
